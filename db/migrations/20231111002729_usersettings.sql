...
INSERT INTO `new_user_settings` (`id`, `created_at`, `updated_at`, `created_by`, `updated_by`, `locked`, `silenced_at`, `suspended_at`, `recovery_code`, `status`, `role`, `permissions`, `email_confirmed`, `tags`, `user_setting`) SELECT `id`, `created_at`, `updated_at`, `created_by`, `updated_by`, `locked`, `silenced_at`, `suspended_at`, `recovery_code`, `status`, `role`, `permissions`, IFNULL(`email_confirmed`, (false)) AS `email_confirmed`, `tags`, `user_setting` FROM `user_settings`;
