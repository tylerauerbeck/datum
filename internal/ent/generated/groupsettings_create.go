...
func (gsc *GroupSettingsCreate) SetID(i idx.ID) *GroupSettingsCreate {
	gsc.mutation.SetID(i)
	return gsc
}

// SetGroupID sets the "group" edge to the Group entity by ID.
func (gsc *GroupSettingsCreate) SetGroupID(id idx.ID) *GroupSettingsCreate {
	gsc.mutation.SetGroupID(id)
	return gsc
}

// SetNillableGroupID sets the "group" edge to the Group entity by ID if the given value is not nil.
func (gsc *GroupSettingsCreate) SetNillableGroupID(id *idx.ID) *GroupSettingsCreate {
	if id != nil {
