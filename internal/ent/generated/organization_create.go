...
func (oc *OrganizationCreate) SetID(i idx.ID) *OrganizationCreate {
	oc.mutation.SetID(i)
	return oc
}

// SetParentID sets the "parent" edge to the Organization entity by ID.
func (oc *OrganizationCreate) SetParentID(id idx.ID) *OrganizationCreate {
...
func (oc *OrganizationCreate) SetNillableParentID(id *idx.ID) *OrganizationCreate {
	if id != nil {
...
func (oc *OrganizationCreate) AddChildIDs(ids ...idx.ID) *OrganizationCreate {
...
func (oc *OrganizationCreate) AddUserIDs(ids ...idx.ID) *OrganizationCreate {
...
func (oc *OrganizationCreate) AddGroupIDs(ids ...idx.ID) *OrganizationCreate {
...
func (oc *OrganizationCreate) AddIntegrationIDs(ids ...idx.ID) *OrganizationCreate {
