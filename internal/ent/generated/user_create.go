...
func (uc *UserCreate) SetID(n nanox.ID) *UserCreate {
	uc.mutation.SetID(n)
	return uc
}

// SetNillableID sets the "id" field if the given value is not nil.
func (uc *UserCreate) SetNillableID(n *nanox.ID) *UserCreate {
	if n != nil {
		uc.SetID(*n)
	}
	return uc
...
func (uc *UserCreate) AddOrganizationIDs(ids ...nanox.ID) *UserCreate {
...
func (uc *UserCreate) AddSessionIDs(ids ...nanox.ID) *UserCreate {
...
func (uc *UserCreate) AddGroupIDs(ids ...nanox.ID) *UserCreate {
