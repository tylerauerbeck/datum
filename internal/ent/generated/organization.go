...
func (*Organization) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case organization.FieldID:
			values[i] = new(idx.ID)
		case organization.FieldCreatedBy, organization.FieldUpdatedBy, organization.FieldName, organization.FieldDescription, organization.FieldParentOrganizationID:
