...
func (oq *OrganizationQuery) FirstID(ctx context.Context) (id nanox.ID, err error) {
	var ids []nanox.ID
...
func (oq *OrganizationQuery) FirstIDX(ctx context.Context) nanox.ID {
...
func (oq *OrganizationQuery) OnlyID(ctx context.Context) (id nanox.ID, err error) {
	var ids []nanox.ID
...
func (oq *OrganizationQuery) OnlyIDX(ctx context.Context) nanox.ID {
...
func (oq *OrganizationQuery) IDs(ctx context.Context) (ids []nanox.ID, err error) {
...
func (oq *OrganizationQuery) IDsX(ctx context.Context) []nanox.ID {
	ids, err := oq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (oq *OrganizationQuery) loadParent(ctx context.Context, query *OrganizationQuery, nodes []*Organization, init func(*Organization), assign func(*Organization, *Organization)) error {
	...
	nodeids := make(map[nanox.ID][]*Organization)
	for i := range nodes {
...
func (oq *OrganizationQuery) loadUsers(ctx context.Context, query *UserQuery, nodes []*Organization, init func(*Organization), assign func(*Organization, *User)) error {
	...
	byID := make(map[nanox.ID]*Organization)
	nids := make(map[nanox.ID]map[*Organization]struct{})
