...
type GroupWhereInput struct {
	...
	IDNEQ   *idx.ID  `json:"idNEQ,omitempty"`
	IDIn    []idx.ID `json:"idIn,omitempty"`
	IDNotIn []idx.ID `json:"idNotIn,omitempty"`
	IDGT    *idx.ID  `json:"idGT,omitempty"`
	IDGTE   *idx.ID  `json:"idGTE,omitempty"`
	IDLT    *idx.ID  `json:"idLT,omitempty"`
	IDLTE   *idx.ID  `json:"idLTE,omitempty"`
