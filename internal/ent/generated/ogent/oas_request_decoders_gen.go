...
func (s *Server) decodeCreateRefreshTokenRequest(r *http.Request) (
	...
	case ct == "application/json":
		...
		var request CreateRefreshTokenReq
		if err := func() error {
			if err := request.Decode(d); err != nil {
				return err
			}
...
func (s *Server) decodeUpdateRefreshTokenRequest(r *http.Request) (
	...
	case ct == "application/json":
		...
		var request UpdateRefreshTokenReq
		if err := func() error {
			if err := request.Decode(d); err != nil {
				return err
			}
