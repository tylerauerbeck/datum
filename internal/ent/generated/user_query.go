...
func (uq *UserQuery) FirstID(ctx context.Context) (id nanox.ID, err error) {
	var ids []nanox.ID
...
func (uq *UserQuery) FirstIDX(ctx context.Context) nanox.ID {
...
func (uq *UserQuery) OnlyID(ctx context.Context) (id nanox.ID, err error) {
	var ids []nanox.ID
...
func (uq *UserQuery) OnlyIDX(ctx context.Context) nanox.ID {
...
func (uq *UserQuery) IDs(ctx context.Context) (ids []nanox.ID, err error) {
...
func (uq *UserQuery) IDsX(ctx context.Context) []nanox.ID {
	ids, err := uq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (uq *UserQuery) loadOrganizations(ctx context.Context, query *OrganizationQuery, nodes []*User, init func(*User), assign func(*User, *Organization)) error {
	...
	byID := make(map[nanox.ID]*User)
	nids := make(map[nanox.ID]map[*User]struct{})
...
func (uq *UserQuery) loadSessions(ctx context.Context, query *SessionQuery, nodes []*User, init func(*User), assign func(*User, *Session)) error {
	...
	nodeids := make(map[nanox.ID]*User)
	for i := range nodes {
