...
func (uq *UserQuery) FirstID(ctx context.Context) (id idx.ID, err error) {
	var ids []idx.ID
...
func (uq *UserQuery) FirstIDX(ctx context.Context) idx.ID {
...
func (uq *UserQuery) OnlyID(ctx context.Context) (id idx.ID, err error) {
	var ids []idx.ID
...
func (uq *UserQuery) OnlyIDX(ctx context.Context) idx.ID {
...
func (uq *UserQuery) IDs(ctx context.Context) (ids []idx.ID, err error) {
...
func (uq *UserQuery) IDsX(ctx context.Context) []idx.ID {
	ids, err := uq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (uq *UserQuery) loadOrganizations(ctx context.Context, query *OrganizationQuery, nodes []*User, init func(*User), assign func(*User, *Organization)) error {
	...
	byID := make(map[idx.ID]*User)
	nids := make(map[idx.ID]map[*User]struct{})
