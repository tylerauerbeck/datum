...
func (opd *OauthProviderDelete) sqlExec(ctx context.Context) (int, error) {
	_spec := sqlgraph.NewDeleteSpec(oauthprovider.Table, sqlgraph.NewFieldSpec(oauthprovider.FieldID, field.TypeString))
	_spec.Node.Schema = opd.schemaConfig.OauthProvider
