...
func WithNodeType(f func(context.Context, nanox.ID) (string, error)) NodeOption {
...
func WithFixedNodeType(t string) NodeOption {
	return WithNodeType(func(context.Context, nanox.ID) (string, error) {
		return t, nil
	})
}

type nodeOptions struct {
	nodeType func(context.Context, nanox.ID) (string, error)
}
...
func (c *Client) newNodeOpts(opts []NodeOption) *nodeOptions {
	...
	if nopts.nodeType == nil {
		nopts.nodeType = func(ctx context.Context, id nanox.ID) (string, error) {
...
func (c *Client) Noder(ctx context.Context, id nanox.ID, opts ...NodeOption) (_ Noder, err error) {
	defer func() {
		if IsNotFound(err) {
...
func (c *Client) noder(ctx context.Context, table string, id nanox.ID) (Noder, error) {
	switch table {
	case group.Table:
		var uid nanox.ID
...
func (c *Client) Noders(ctx context.Context, ids []nanox.ID, opts ...NodeOption) ([]Noder, error) {
	switch len(ids) {
	case 1:
	...
	tables := make(map[string][]nanox.ID)
	id2idx := make(map[nanox.ID][]int, len(ids))
...
func (c *Client) noders(ctx context.Context, table string, ids []nanox.ID) ([]Noder, error) {
	noders := make([]Noder, len(ids))
	idmap := make(map[nanox.ID][]*Noder, len(ids))
	for i, id := range ids {
