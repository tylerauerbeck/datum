...
func (gu *GroupUpdate) SetSettingID(id idx.ID) *GroupUpdate {
...
func (gu *GroupUpdate) AddUserIDs(ids ...idx.ID) *GroupUpdate {
...
func (gu *GroupUpdate) SetOwnerID(id idx.ID) *GroupUpdate {
...
func (gu *GroupUpdate) SetNillableOwnerID(id *idx.ID) *GroupUpdate {
	if id != nil {
		gu = gu.SetOwnerID(*id)
	}
	return gu
...
func (gu *GroupUpdate) RemoveUserIDs(ids ...idx.ID) *GroupUpdate {
...
// SetSettingID sets the "setting" edge to the GroupSettings entity by ID.
func (guo *GroupUpdateOne) SetSettingID(id idx.ID) *GroupUpdateOne {
...
// AddUserIDs adds the "users" edge to the User entity by IDs.
func (guo *GroupUpdateOne) AddUserIDs(ids ...idx.ID) *GroupUpdateOne {
...
// SetOwnerID sets the "owner" edge to the Organization entity by ID.
func (guo *GroupUpdateOne) SetOwnerID(id idx.ID) *GroupUpdateOne {
	guo.mutation.SetOwnerID(id)
	return guo
}

// SetNillableOwnerID sets the "owner" edge to the Organization entity by ID if the given value is not nil.
func (guo *GroupUpdateOne) SetNillableOwnerID(id *idx.ID) *GroupUpdateOne {
	if id != nil {
...
// RemoveUserIDs removes the "users" edge to User entities by IDs.
func (guo *GroupUpdateOne) RemoveUserIDs(ids ...idx.ID) *GroupUpdateOne {
