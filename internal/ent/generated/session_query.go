...
func (sq *SessionQuery) FirstID(ctx context.Context) (id idx.ID, err error) {
	var ids []idx.ID
...
func (sq *SessionQuery) FirstIDX(ctx context.Context) idx.ID {
...
func (sq *SessionQuery) OnlyID(ctx context.Context) (id idx.ID, err error) {
	var ids []idx.ID
...
func (sq *SessionQuery) OnlyIDX(ctx context.Context) idx.ID {
...
func (sq *SessionQuery) IDs(ctx context.Context) (ids []idx.ID, err error) {
...
func (sq *SessionQuery) IDsX(ctx context.Context) []idx.ID {
	ids, err := sq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (sq *SessionQuery) loadUsers(ctx context.Context, query *UserQuery, nodes []*Session, init func(*Session), assign func(*Session, *User)) error {
	...
	nodeids := make(map[idx.ID][]*Session)
	for i := range nodes {
