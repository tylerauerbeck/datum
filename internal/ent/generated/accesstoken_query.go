...
type AccessTokenQuery struct {
	...
	loadTotal  []func(context.Context, []*AccessToken) error
...
func (atq *AccessTokenQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*AccessToken, error) {
	...
	if query := atq.withOwner; query != nil {
		if err := atq.loadOwner(ctx, query, nodes, nil,
			func(n *AccessToken, e *User) { n.Edges.Owner = e }); err != nil {
			return nil, err
		}
	}
...
func (atq *AccessTokenQuery) loadOwner(ctx context.Context, query *UserQuery, nodes []*AccessToken, init func(*AccessToken), assign func(*AccessToken, *User)) error {
