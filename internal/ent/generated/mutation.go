...
type GroupMutation struct {
	...
	setting        *idx.ID
	clearedsetting bool
	users          map[idx.ID]struct{}
	removedusers   map[idx.ID]struct{}
	clearedusers   bool
	owner          *idx.ID
	clearedowner   bool
	done           bool
...
func withGroupID(id idx.ID) groupOption {
...
func (m *GroupMutation) SetID(id idx.ID) {
	m.id = &id
}

// ID returns the ID value in the mutation. Note that the ID is only available
// if it was provided to the builder or after it was returned from the database.
func (m *GroupMutation) ID() (id idx.ID, exists bool) {
	if m.id == nil {
		return
	}
	return *m.id, true
...
func (m *GroupMutation) IDs(ctx context.Context) ([]idx.ID, error) {
	switch {
	case m.op.Is(OpUpdateOne | OpDeleteOne):
		id, exists := m.ID()
		if exists {
			return []idx.ID{id}, nil
		}
		fallthrough
...
func (m *GroupMutation) SetSettingID(id idx.ID) {
	m.setting = &id
}
...
func (m *GroupMutation) SettingID() (id idx.ID, exists bool) {
	if m.setting != nil {
...
func (m *GroupMutation) SettingIDs() (ids []idx.ID) {
...
func (m *GroupMutation) AddUserIDs(ids ...idx.ID) {
	if m.users == nil {
		m.users = make(map[idx.ID]struct{})
	}
	for i := range ids {
...
func (m *GroupMutation) RemoveUserIDs(ids ...idx.ID) {
	if m.removedusers == nil {
		m.removedusers = make(map[idx.ID]struct{})
	}
	for i := range ids {
...
func (m *GroupMutation) RemovedUsersIDs() (ids []idx.ID) {
...
func (m *GroupMutation) UsersIDs() (ids []idx.ID) {
...
func (m *GroupMutation) SetOwnerID(id idx.ID) {
	m.owner = &id
}
...
func (m *GroupMutation) OwnerID() (id idx.ID, exists bool) {
	if m.owner != nil {
		return *m.owner, true
	}
	return
...
func (m *GroupMutation) OwnerIDs() (ids []idx.ID) {
...
func withGroupSettingsID(id idx.ID) groupsettingsOption {
...
func (m *GroupSettingsMutation) SetID(id idx.ID) {
	m.id = &id
}

// ID returns the ID value in the mutation. Note that the ID is only available
// if it was provided to the builder or after it was returned from the database.
func (m *GroupSettingsMutation) ID() (id idx.ID, exists bool) {
	if m.id == nil {
		return
	}
	return *m.id, true
...
// as sql.LevelSerializable, the returned ids match the ids of the rows that will be updated
// or updated by the mutation.
func (m *GroupSettingsMutation) IDs(ctx context.Context) ([]idx.ID, error) {
	switch {
	case m.op.Is(OpUpdateOne | OpDeleteOne):
		id, exists := m.ID()
		if exists {
...
func (m *GroupSettingsMutation) SetGroupID(id idx.ID) {
	m.group = &id
}
...
func (m *GroupSettingsMutation) GroupID() (id idx.ID, exists bool) {
	if m.group != nil {
		return *m.group, true
	}
	return
...
func (m *GroupSettingsMutation) GroupIDs() (ids []idx.ID) {
...
func withIntegrationID(id idx.ID) integrationOption {
...
func (m *IntegrationMutation) SetID(id idx.ID) {
	m.id = &id
}

// ID returns the ID value in the mutation. Note that the ID is only available
// if it was provided to the builder or after it was returned from the database.
func (m *IntegrationMutation) ID() (id idx.ID, exists bool) {
	if m.id == nil {
		return
	}
	return *m.id, true
...
// as sql.LevelSerializable, the returned ids match the ids of the rows that will be updated
// or updated by the mutation.
func (m *IntegrationMutation) IDs(ctx context.Context) ([]idx.ID, error) {
	switch {
	case m.op.Is(OpUpdateOne | OpDeleteOne):
		id, exists := m.ID()
		if exists {
...
// SetOwnerID sets the "owner" edge to the Organization entity by id.
func (m *IntegrationMutation) SetOwnerID(id idx.ID) {
	m.owner = &id
}
...
// OwnerID returns the "owner" edge ID in the mutation.
func (m *IntegrationMutation) OwnerID() (id idx.ID, exists bool) {
	if m.owner != nil {
		return *m.owner, true
	}
	return
...
// Note that IDs always returns len(IDs) <= 1 for unique edges, and you should use
// OwnerID instead. It exists only for internal usage by the builders.
func (m *IntegrationMutation) OwnerIDs() (ids []idx.ID) {
	if id := m.owner; id != nil {
		ids = append(ids, *id)
	}
	return
...
type OrganizationMutation struct {
	...
	parent              *idx.ID
	clearedparent       bool
	children            map[idx.ID]struct{}
	removedchildren     map[idx.ID]struct{}
	clearedchildren     bool
	users               map[idx.ID]struct{}
	removedusers        map[idx.ID]struct{}
	clearedusers        bool
	groups              map[idx.ID]struct{}
	removedgroups       map[idx.ID]struct{}
	clearedgroups       bool
	integrations        map[idx.ID]struct{}
	removedintegrations map[idx.ID]struct{}
...
func withOrganizationID(id idx.ID) organizationOption {
...
func (m *OrganizationMutation) SetID(id idx.ID) {
	m.id = &id
}

// ID returns the ID value in the mutation. Note that the ID is only available
// if it was provided to the builder or after it was returned from the database.
func (m *OrganizationMutation) ID() (id idx.ID, exists bool) {
	if m.id == nil {
		return
	}
	return *m.id, true
...
// as sql.LevelSerializable, the returned ids match the ids of the rows that will be updated
// or updated by the mutation.
func (m *OrganizationMutation) IDs(ctx context.Context) ([]idx.ID, error) {
	switch {
	case m.op.Is(OpUpdateOne | OpDeleteOne):
		id, exists := m.ID()
		if exists {
...
func (m *OrganizationMutation) SetParentID(id idx.ID) {
	m.parent = &id
}
...
func (m *OrganizationMutation) ParentID() (id idx.ID, exists bool) {
	if m.parent != nil {
...
func (m *OrganizationMutation) ParentIDs() (ids []idx.ID) {
...
func (m *OrganizationMutation) AddChildIDs(ids ...idx.ID) {
	if m.children == nil {
		m.children = make(map[idx.ID]struct{})
	}
	for i := range ids {
...
func (m *OrganizationMutation) RemoveChildIDs(ids ...idx.ID) {
	if m.removedchildren == nil {
		m.removedchildren = make(map[idx.ID]struct{})
	}
	for i := range ids {
...
func (m *OrganizationMutation) RemovedChildrenIDs() (ids []idx.ID) {
...
func (m *OrganizationMutation) ChildrenIDs() (ids []idx.ID) {
...
// AddUserIDs adds the "users" edge to the User entity by ids.
func (m *OrganizationMutation) AddUserIDs(ids ...idx.ID) {
	if m.users == nil {
		m.users = make(map[idx.ID]struct{})
	}
	for i := range ids {
...
// RemoveUserIDs removes the "users" edge to the User entity by IDs.
func (m *OrganizationMutation) RemoveUserIDs(ids ...idx.ID) {
	if m.removedusers == nil {
		m.removedusers = make(map[idx.ID]struct{})
	}
	for i := range ids {
...
// RemovedUsers returns the removed IDs of the "users" edge to the User entity.
func (m *OrganizationMutation) RemovedUsersIDs() (ids []idx.ID) {
	for id := range m.removedusers {
		ids = append(ids, id)
	}
	return
...
// UsersIDs returns the "users" edge IDs in the mutation.
func (m *OrganizationMutation) UsersIDs() (ids []idx.ID) {
	for id := range m.users {
		ids = append(ids, id)
	}
	return
...
func (m *OrganizationMutation) AddGroupIDs(ids ...idx.ID) {
	if m.groups == nil {
		m.groups = make(map[idx.ID]struct{})
	}
	for i := range ids {
...
func (m *OrganizationMutation) RemoveGroupIDs(ids ...idx.ID) {
	if m.removedgroups == nil {
		m.removedgroups = make(map[idx.ID]struct{})
	}
	for i := range ids {
...
func (m *OrganizationMutation) RemovedGroupsIDs() (ids []idx.ID) {
...
func (m *OrganizationMutation) GroupsIDs() (ids []idx.ID) {
...
func (m *OrganizationMutation) AddIntegrationIDs(ids ...idx.ID) {
	if m.integrations == nil {
		m.integrations = make(map[idx.ID]struct{})
	}
	for i := range ids {
...
func (m *OrganizationMutation) RemoveIntegrationIDs(ids ...idx.ID) {
	if m.removedintegrations == nil {
		m.removedintegrations = make(map[idx.ID]struct{})
	}
	for i := range ids {
...
func (m *OrganizationMutation) RemovedIntegrationsIDs() (ids []idx.ID) {
...
func (m *OrganizationMutation) IntegrationsIDs() (ids []idx.ID) {
...
func withSessionID(id idx.ID) sessionOption {
...
func (m *SessionMutation) SetID(id idx.ID) {
	m.id = &id
}

// ID returns the ID value in the mutation. Note that the ID is only available
// if it was provided to the builder or after it was returned from the database.
func (m *SessionMutation) ID() (id idx.ID, exists bool) {
	if m.id == nil {
		return
	}
	return *m.id, true
...
// as sql.LevelSerializable, the returned ids match the ids of the rows that will be updated
// or updated by the mutation.
func (m *SessionMutation) IDs(ctx context.Context) ([]idx.ID, error) {
	switch {
	case m.op.Is(OpUpdateOne | OpDeleteOne):
		id, exists := m.ID()
		if exists {
...
func (m *SessionMutation) SetUsersID(id idx.ID) {
	m.users = &id
}
...
func (m *SessionMutation) UsersID() (id idx.ID, exists bool) {
	if m.users != nil {
		return *m.users, true
	}
	return
...
func (m *SessionMutation) UsersIDs() (ids []idx.ID) {
...
type UserMutation struct {
	...
	clearedFields        map[string]struct{}
	organizations        map[idx.ID]struct{}
	removedorganizations map[idx.ID]struct{}
	clearedorganizations bool
	sessions             map[idx.ID]struct{}
	removedsessions      map[idx.ID]struct{}
...
func withUserID(id idx.ID) userOption {
...
func (m *UserMutation) SetID(id idx.ID) {
	m.id = &id
}

// ID returns the ID value in the mutation. Note that the ID is only available
// if it was provided to the builder or after it was returned from the database.
func (m *UserMutation) ID() (id idx.ID, exists bool) {
	if m.id == nil {
		return
	}
	return *m.id, true
...
// as sql.LevelSerializable, the returned ids match the ids of the rows that will be updated
// or updated by the mutation.
func (m *UserMutation) IDs(ctx context.Context) ([]idx.ID, error) {
	switch {
	case m.op.Is(OpUpdateOne | OpDeleteOne):
		id, exists := m.ID()
		if exists {
...
func (m *UserMutation) AddOrganizationIDs(ids ...idx.ID) {
	if m.organizations == nil {
		m.organizations = make(map[idx.ID]struct{})
	}
	for i := range ids {
...
func (m *UserMutation) RemoveOrganizationIDs(ids ...idx.ID) {
	if m.removedorganizations == nil {
		m.removedorganizations = make(map[idx.ID]struct{})
	}
	for i := range ids {
...
func (m *UserMutation) RemovedOrganizationsIDs() (ids []idx.ID) {
...
func (m *UserMutation) OrganizationsIDs() (ids []idx.ID) {
...
func (m *UserMutation) AddSessionIDs(ids ...idx.ID) {
	if m.sessions == nil {
		m.sessions = make(map[idx.ID]struct{})
	}
	for i := range ids {
...
func (m *UserMutation) RemoveSessionIDs(ids ...idx.ID) {
	if m.removedsessions == nil {
		m.removedsessions = make(map[idx.ID]struct{})
	}
	for i := range ids {
...
func (m *UserMutation) RemovedSessionsIDs() (ids []idx.ID) {
...
func (m *UserMutation) SessionsIDs() (ids []idx.ID) {
...
// AddGroupIDs adds the "groups" edge to the Group entity by ids.
func (m *UserMutation) AddGroupIDs(ids ...idx.ID) {
	if m.groups == nil {
		m.groups = make(map[idx.ID]struct{})
	}
	for i := range ids {
...
// RemoveGroupIDs removes the "groups" edge to the Group entity by IDs.
func (m *UserMutation) RemoveGroupIDs(ids ...idx.ID) {
	if m.removedgroups == nil {
		m.removedgroups = make(map[idx.ID]struct{})
	}
	for i := range ids {
...
// RemovedGroups returns the removed IDs of the "groups" edge to the Group entity.
func (m *UserMutation) RemovedGroupsIDs() (ids []idx.ID) {
	for id := range m.removedgroups {
		ids = append(ids, id)
	}
	return
...
// GroupsIDs returns the "groups" edge IDs in the mutation.
func (m *UserMutation) GroupsIDs() (ids []idx.ID) {
	for id := range m.groups {
		ids = append(ids, id)
	}
	return
