...
func init() {
	...
	group.DefaultID = groupDescID.Default.(func() nanox.ID)
	...
	groupsettings.DefaultID = groupsettingsDescID.Default.(func() nanox.ID)
	...
	integration.DefaultID = integrationDescID.Default.(func() nanox.ID)
	...
	organization.DefaultID = organizationDescID.Default.(func() nanox.ID)
	...
	session.DefaultID = sessionDescID.Default.(func() nanox.ID)
	...
	user.DefaultID = userDescID.Default.(func() nanox.ID)
}
