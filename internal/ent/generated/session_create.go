...
func (sc *SessionCreate) SetID(i idx.ID) *SessionCreate {
	sc.mutation.SetID(i)
	return sc
}

// SetUsersID sets the "users" edge to the User entity by ID.
func (sc *SessionCreate) SetUsersID(id idx.ID) *SessionCreate {
	sc.mutation.SetUsersID(id)
	return sc
}

// SetNillableUsersID sets the "users" edge to the User entity by ID if the given value is not nil.
func (sc *SessionCreate) SetNillableUsersID(id *idx.ID) *SessionCreate {
	if id != nil {
		sc = sc.SetUsersID(*id)
	}
	return sc
