...
func (sc *SessionCreate) SetID(n nanox.ID) *SessionCreate {
	sc.mutation.SetID(n)
	return sc
}

// SetNillableID sets the "id" field if the given value is not nil.
func (sc *SessionCreate) SetNillableID(n *nanox.ID) *SessionCreate {
	if n != nil {
		sc.SetID(*n)
	}
	return sc
...
func (sc *SessionCreate) SetUsersID(id nanox.ID) *SessionCreate {
	sc.mutation.SetUsersID(id)
	return sc
}

// SetNillableUsersID sets the "users" edge to the User entity by ID if the given value is not nil.
func (sc *SessionCreate) SetNillableUsersID(id *nanox.ID) *SessionCreate {
	if id != nil {
		sc = sc.SetUsersID(*id)
	}
	return sc
