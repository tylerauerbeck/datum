...
func (gsu *GroupSettingsUpdate) SetGroupID(id idx.ID) *GroupSettingsUpdate {
	gsu.mutation.SetGroupID(id)
	return gsu
}

// SetNillableGroupID sets the "group" edge to the Group entity by ID if the given value is not nil.
func (gsu *GroupSettingsUpdate) SetNillableGroupID(id *idx.ID) *GroupSettingsUpdate {
	if id != nil {
...
// SetGroupID sets the "group" edge to the Group entity by ID.
func (gsuo *GroupSettingsUpdateOne) SetGroupID(id idx.ID) *GroupSettingsUpdateOne {
	gsuo.mutation.SetGroupID(id)
	return gsuo
}

// SetNillableGroupID sets the "group" edge to the Group entity by ID if the given value is not nil.
func (gsuo *GroupSettingsUpdateOne) SetNillableGroupID(id *idx.ID) *GroupSettingsUpdateOne {
	if id != nil {
