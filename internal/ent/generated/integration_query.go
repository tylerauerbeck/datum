...
func (iq *IntegrationQuery) FirstID(ctx context.Context) (id idx.ID, err error) {
	var ids []idx.ID
...
func (iq *IntegrationQuery) FirstIDX(ctx context.Context) idx.ID {
...
func (iq *IntegrationQuery) OnlyID(ctx context.Context) (id idx.ID, err error) {
	var ids []idx.ID
...
func (iq *IntegrationQuery) OnlyIDX(ctx context.Context) idx.ID {
...
func (iq *IntegrationQuery) IDs(ctx context.Context) (ids []idx.ID, err error) {
...
func (iq *IntegrationQuery) IDsX(ctx context.Context) []idx.ID {
	ids, err := iq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (iq *IntegrationQuery) loadOwner(ctx context.Context, query *OrganizationQuery, nodes []*Integration, init func(*Integration), assign func(*Integration, *Organization)) error {
	...
	nodeids := make(map[idx.ID][]*Integration)
	for i := range nodes {
