...
func (gsq *GroupSettingsQuery) FirstID(ctx context.Context) (id idx.ID, err error) {
	var ids []idx.ID
...
func (gsq *GroupSettingsQuery) FirstIDX(ctx context.Context) idx.ID {
...
func (gsq *GroupSettingsQuery) OnlyID(ctx context.Context) (id idx.ID, err error) {
	var ids []idx.ID
...
func (gsq *GroupSettingsQuery) OnlyIDX(ctx context.Context) idx.ID {
...
func (gsq *GroupSettingsQuery) IDs(ctx context.Context) (ids []idx.ID, err error) {
...
func (gsq *GroupSettingsQuery) IDsX(ctx context.Context) []idx.ID {
	ids, err := gsq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (gsq *GroupSettingsQuery) loadGroup(ctx context.Context, query *GroupQuery, nodes []*GroupSettings, init func(*GroupSettings), assign func(*GroupSettings, *Group)) error {
	...
	nodeids := make(map[idx.ID][]*GroupSettings)
	for i := range nodes {
