...
import (
	...
	ulids "github.com/datumforge/datum/internal/utils/ulids"
)

func TestVerificationToken(t *testing.T) {
	// Test that the verification token is created correctly
	token, err := tokens.NewVerificationToken("rusty.shackleford@gmail.com")
	require.NoError(t, err, "could not create verification token")
	require.Equal(t, "rusty.shackleford@gmail.com", token.Email)
	...
	verify.Email = "rusty.shackleford@gmail.com"
